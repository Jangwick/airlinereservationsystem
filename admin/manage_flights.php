                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php 
                                                ...
                                                $booked = $total > 0 ? $total - $available : 0;
                                            ...
                                            <div class="small mt-1"><?php echo $available; ?> available / <?php echo $total; ?> total</div>
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton<?php echo $flight['flight_id']; ?>">
                                                    ...
                                                    <li><a class="dropdown-item" href="#" onclick="updateStatus(<?php echo $flight['flight_id']; ?>)">
                                                        <i class="fas fa-plane-arrival me-2"></i> Update Status
                                                    </a></li>
                                                    <li><hr class="dropdown-divider"></li>
                                                    <li><a class="dropdown-item text-danger" href="#" onclick="confirmDelete(<?php echo $flight['flight_id']; ?>, '<?php echo htmlspecialchars($flight['flight_number']); ?>')">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="statusForm">
                        ...
                        <div class="mb-3" id="delayReasonGroup">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-danger">This action cannot be undone. All bookings associated with this flight will be cancelled.</p>
